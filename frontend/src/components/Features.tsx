                ...
                <div className="features-accordion">
                    <div className="item-1">
                        ...
                        <div className="features-accordion-content">
                            <p>
                            Loyalty, rooted in Ashanti tradition, requires strategic thinking. Survive and outwit your opponent by capturing seeds and securing victory.
                            </p>
                        </div>
                    </div>
                    <div className="item-2">
                        ...
                        <div className="features-accordion-content">
                            <p>
                            Forge unexpected connections with fellow players .Each move you make adds a twist to the unfolding story, making every Loyalty match a unique and thrilling experience.
                            </p>
                        </div>
                    </div>
                    <div className="item-3">
                        ...
                        <div className="features-accordion-content">
                            <p>
                            Impress the audience with your gameplay. Spectators discuss the game, offer advice, and make Loyalty a focal point for entertainment and socializing.
                            </p>
                        </div>
                    </div>
