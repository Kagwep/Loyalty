...
export class Assets {
    ...
    public Units: Map<number, ArmyUnit> = new Map();

    public enemyUnits: Map<number, ArmyUnit> = new Map();
    ...
    public getInfantry(): ArmyUnit[] {
        return this.infantry;
    }

    public getArchers(): ArmyUnit[] {
        return this.archers;
    }

    public getArtillery(): ArmyUnit[] {
