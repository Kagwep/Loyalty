    ...
    return (
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <div className="flex min-w-[14rem] flex-row items-center gap-4 rounded  bg-purple-950   text-xl text-white font-semibold hover:cursor-pointer">
        ...
        <DropdownMenuContent className="min-w-[14rem] border-2 bg-purple-950 text-slate-100 font-medium text-xl" >
          {!activeAccount &&
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild className="">
        <div className="flex min-w-[14rem] flex-row items-center gap-4 rounded  bg-purple-950   text-lg text-white hover:cursor-pointer">
          <div className="border-r-2 border-white px-2 py-2">
            <RiArrowDownSLine size={20} aria-hidden="true" />
          </div>
